            ...
            <div className="footer__container container">
                <div className="footer__content">
                    <div className="footer__brand">
                        <Link to="/" className="footer__logo">
                            <span className="footer__logo-text">Murals</span>
                            <span className="footer__logo-accent">by Kye</span>
                        </Link>
                        <p className="footer__tagline">
                            Transforming spaces into art
                        </p>
                    </div>
                    ...
                    <div className="footer__social">
                        <a
                            href="https://www.instagram.com/muralsbykye"
                            target="_blank"
                ...
                <div className="footer__bottom">
                    <p className="footer__copyright">
                        © {currentYear} Murals by Kye. All rights reserved.
                    </p>
                </div>
            </div>
        </footer>
